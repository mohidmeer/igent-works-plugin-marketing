export default function Page() {
  return (
    ...
    >
      ...
      <h2 class="text-3xl font-bold mt-8">How We Use Your Data</h2>

      <h3 class="text-2xl">Providing and Improving Our Services</h3>
      <p>
      ...
      <h3 class="text-2xl">Responding to Inquiries and Customer Support</h3>
      <p>
      ...
      <h3 class="text-2xl">Analytics and Performance Tracking</h3>
      <p>
      ...
      <h3 class="text-2xl">Marketing and Promotional Purposes</h3>
      <p>
      ...
      <h2 class="text-3xl font-bold mt-8">Data Sharing and Disclosure</h2>
      <p>
        We may share your information in the following circumstances:
      </p>

      <h3 class="text-2xl ">Service Providers</h3>
      <p>
      ...
      <h3 class="text-2xl ">Legal Requirements</h3>
      <p>
      ...
      <h3 class="text-2xl ">Protection of Rights</h3>
      <p>
      ...
      <h2 class="text-3xl font-bold mt-8">Data Security</h2>
      <p>
      ...
      <h2 class="text-3xl font-bold mt-8">Your Rights and Choices</h2>
      <p >
        Depending on your location, you may have certain rights regarding your personal information:
      </p>

      <h3 class="text-2xl ">Access and Correction</h3>
      <p >
      ...
      <h2 class="text-3xl font-bold">Cookies and Tracking Technologies</h2>
      <p>
      ...
      <h2 class="text-3xl font-bold">Children's Privacy</h2>
      <p>
      ...
      <h2 class="text-3xl font-bold">Changes to This Privacy Policy</h2>
      <p>
